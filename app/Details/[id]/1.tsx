...
const TodoDetails = () => {
  ...
  const {title, name, description } = todoDetails;
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white shadow-md p-8 rounded-lg">
        <img src="https://media.istockphoto.com/id/1251044352/photo/loading-the-container-in-the-cargo-airplane.jpg?s=612x612&w=0&k=20&c=6G_RG9oepmELAqXEtjAh7N9x8_b2krD0cs3hMzps8Q0=" alt='alt' className="w-full h-auto object-cover mb-4" />
